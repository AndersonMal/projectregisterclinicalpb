                                    ...
                                    <div class="card-body">
                                        <form  id="frmChangePassword" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="new_password" name="new_password" type="password" placeholder="Escribe tu contraseña" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword"><i class="fas fa-key"></i>Confirmar contraseña</label>
                                                <input class="form-control py-4" id="confirm_password" name="confirm_password" type="password" placeholder="Escribe tu contraseña" />
                                            </div>
